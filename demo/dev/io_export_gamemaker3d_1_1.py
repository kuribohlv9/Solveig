bl_info = {
        ...
        "warning": "",
        "wiki_url": "",
        "tracker_url": "http://blog.martincrownover.com/blender-addon-gm3d",
        "category": "Import-Export"}

'''
Usage Notes:
		Build your 3D model, select it, then go to File > Export > GameMaker Model Script.
...
class Export_gm3d(bpy.types.Operator, ExportHelper):
        '''Exports the active Object as a GameMaker: Studio model script'''
        bl_idname = "export_object.txt"
        bl_label = "Export GameMaker 3D Model Script (.txt)"
...
def menu_func(self, context):
        self.layout.operator(Export_gm3d.bl_idname, text="GameMaker Model Script (.txt)")
